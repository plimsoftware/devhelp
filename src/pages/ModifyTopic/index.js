...
useEffect(() => {
    ...
    dbInstance.readTopic(myCategoy)
      .then(allTopicslists => {
...
const handleSubmit = () => {
    ipcRenderer.send('updateTopic',{ _id: topSelected._id , topictext: topicName, oldtext: topSelected.topictext });
};
            ...
            {topSelected === '' ? (
                ...
                <div>
                    ...
                    <form onSubmit={handleSubmit}>
                        <input autoFocus type="text" value={topicName} onChange={(e) => setTopicName(e.currentTarget.value)}></input>
